...
var BattleStatuses = {
    ...
    confusion: {
        ...
        onBeforeMove: function (pokemon, target) {
            ...
            if (!this.randomChance(128, 256)) {
                var damage = Math.floor(Math.floor(((Math.floor(2 * pokemon.level / 5) + 2) * pokemon.getStat('atk') * 40) / pokemon.getStat('def', false)) / 50) + 2;
    ...
    partialtrappinglock: {
        ...
        durationCallback: function () {
            var duration = this.sample([2, 2, 2, 3, 3, 3, 4, 5]);
            return duration;
        },
...
var BattleStatusesString = JSON.stringify(BattleStatuses, null, "\t")
console.log(BattleStatusesString)
