var BattleMovedex = {
    ...
    bide: {
        ...
        effect: {
            ...
            onBeforeMove: function (pokemon, t, move) {
    ...
    counter: {
        ...
        damageCallback: function (pokemon, target) {
            ...
            var lastUsedMove = target.side.lastMove && this.dex.getMove(target.side.lastMove.id);
            if (lastUsedMove && lastUsedMove.basePower > 0 && ['Normal', 'Fighting'].includes(lastUsedMove.type) &&
    ...
    disable: {
        ...
        effect: {
            ...
            onStart: function (pokemon) {
                ...
                var move = this.dex.getMove(this.sample(moves));
    ...
    haze: {
        ...
        onHit: function (target, source) {
            ...
            for (var _i = 0, _a = this.getAllActive(); _i < _a.length; _i++) {
                ...
                for (var _b = 0, _c = Object.keys(pokemon.volatiles); _b < _c.length; _b++) {
                    var id = _c[_b];
                    if (id === 'residualdmg') {
    ...
    leechseed: {
        ...
        effect: {
            ...
            onAfterMoveSelf: function (pokemon) {
                ...
                var toxicCounter = 1;
                var residualdmg = pokemon.volatiles['residualdmg'];
                if (residualdmg) {
                    residualdmg.counter++;
                    toxicCounter = residualdmg.counter;
                }
                var toLeech = this.clampIntRange(Math.floor(pokemon.baseMaxhp / 16), 1) * toxicCounter;
        ...
        effect: {
            ...
            onTryHit: function (target, source, move) {
                if (move.category === 'Status') {
                    ...
                    var SubBlocked = ['lockon', 'meanlook', 'mindreader', 'nightmare'];
                ...
                var uncappedDamage = move.hit > 1 ? source.lastDamage : this.getDamage(source, target, move);
                if (!uncappedDamage)
                    return null;
