...
var BattleMovedex = {
            ...
            for (var _i = 0, _a = target.side.pokemon; _i < _a.length; _i++) {
                ...
                for (var _b = 0, _c = pokemon.moveSlots; _b < _c.length; _b++) {
                    ...
                    if (noAssist.includes(moveid))
                        continue;
                    var move = this.dex.getMove(moveid);
        ...
        effect: {
            ...
            onBeforeMove: function (pokemon, target, move) {
                if (this.effectData.duration === 1) {
                    ...
                    if (!target.isActive) {
                        var possibleTarget = this.getRandomTarget(pokemon, this.dex.getMove('pound'));
                        if (!possibleTarget) {
    ...
    conversion: {
        ...
        flags: { snatch: 1 },
        onHit: function (target) {
            var type = this.dex.getMove(target.moveSlots[0].id).type;
    ...
    conversion2: {
        ...
        onHit: function (target, source) {
            ...
            var possibleTypes = [];
            var attackType = target.lastMove.type;
            for (var type in this.dex.data.TypeChart) {
                if (source.hasType(type))
                    continue;
                var typeCheck = this.dex.data.TypeChart[type].damageTaken[attackType];
    ...
    courtchange: {
        ...
        onHitField: function (target, source) {
            ...
            for (var _i = 0, sideConditions_1 = sideConditions; _i < sideConditions_1.length; _i++) {
                ...
                var effectName = this.dex.getEffect(id).name;
                if (sourceSide.sideConditions[id] && targetSide.sideConditions[id]) {
                    _a = [
                        targetSide.sideConditions[id], sourceSide.sideConditions[id],
                    ], sourceSide.sideConditions[id] = _a[0], targetSide.sideConditions[id] = _a[1];
    ...
    firepledge: {
        ...
        effect: {
            ...
            onEnd: function (targetSide) {
                for (var _i = 0, _a = targetSide.active; _i < _a.length; _i++) {
                    var pokemon = _a[_i];
    ...
    flameburst: {
        ...
        onHit: function (target, source, move) {
            ...
            for (var _i = 0, _a = target.side.active; _i < _a.length; _i++) {
                var ally = _a[_i];
    ...
    gmaxbefuddle: {
        ...
        self: {
            onHit: function (source) {
                for (var _i = 0, _a = source.side.foe.active; _i < _a.length; _i++) {
                    var pokemon = _a[_i];
    ...
    gmaxcannonade: {
        ...
        effect: {
            ...
            onResidual: function (targetSide) {
                for (var _i = 0, _a = targetSide.active; _i < _a.length; _i++) {
                    var pokemon = _a[_i];
    ...
    gmaxchistrike: {
        ...
        self: {
            onHit: function (source) {
                for (var _i = 0, _a = source.side.active; _i < _a.length; _i++) {
                    var pokemon = _a[_i];
            ...
            onHit: function (source) {
                for (var _i = 0, _a = source.side.foe.active; _i < _a.length; _i++) {
                    ...
                    if (move && !move.isZ && !move.isMax) {
                        var ppDeducted = pokemon.deductPP(move.id, 4);
                        if (ppDeducted) {
    ...
    imprison: {
        ...
        effect: {
            ...
            onFoeDisableMove: function (pokemon) {
                for (var _i = 0, _a = this.effectData.source.moveSlots; _i < _a.length; _i++) {
                    var moveSlot = _a[_i];
    ...
    lunardance: {
        ...
        effect: {
            ...
            onStart: function (side, source) {
                ...
                for (var _i = 0, _a = side.active.keys(); _i < _a.length; _i++) {
                    var i = _a[_i];
            ...
            onSwitchIn: function (target) {
                var positions = this.effectData.positions;
                ...
                if (!positions.some(function (affected) { return affected === true; })) {
    ...
    magneticflux: {
        ...
        onHitSide: function (side, source, move) {
            ...
            if (!targets.length)
                return false;
            var didSomething = false;
            for (var _b = 0, targets_3 = targets; _b < targets_3.length; _b++) {
                var target = targets_3[_b];
    ...
    maxguard: {
        ...
        effect: {
            ...
            onTryHit: function (target, source, move) {
                ...
                var blockedByMaxGuard = move.flags['protect'] || move.isZ || move.isMax || overrideBypassProtect.includes(move.id);
    ...
    metronome: {
        ...
        onHit: function (target, source, effect) {
            var moves = [];
            for (var id in exports.BattleMovedex) {
                var move = exports.BattleMovedex[id];
                if (move.realMove)
                    continue;
        ...
        effect: {
            ...
            onTryHit: function (target, source, effect) {
                ...
                if (!target.isGrounded()) {
                    var baseMove = this.dex.getMove(effect.id);
    ...
    pursuit: {
        ...
        effect: {
            ...
            onBeforeSwitchOut: function (pokemon) {
                ...
                pokemon.removeVolatile('destinybond');
                for (var _i = 0, _a = this.effectData.sources; _i < _a.length; _i++) {
                    var source = _a[_i];
    ...
    ragepowder: {
        ...
        effect: {
            ...
            onFoeRedirectTargetPriority: 1,
            onFoeRedirectTarget: function (target, source, source2, move) {
                var ragePowderUser = this.effectData.target;
    ...
    round: {
        ...
        priority: 0,
        flags: { protect: 1, mirror: 1, sound: 1, authentic: 1 },
        onTry: function (target, source, move) {
            var _a;
    ...
    taunt: {
        ...
        effect: {
            ...
            onDisableMove: function (pokemon) {
                for (var _i = 0, _a = pokemon.moveSlots; _i < _a.length; _i++) {
                    var moveSlot = _a[_i];
                    var move = this.dex.getMove(moveSlot.id);
    ...
    uproar: {
        ...
        onTryHit: function (target) {
            for (var _i = 0, _a = target.side.active.entries(); _i < _a.length; _i++) {
...
var BattleMovedexString = JSON.stringify(BattleMovedex, null, "\t")
console.log(BattleMovedexString)
